...
Obs: Pedimos a instalação do R, Rstudio e Qgis como pré-requisito, uma vez que público de pós em geral já usa/usou essas ferramentas. Se não for o caso, no links a seguir existem instruções para essas instalações:
...
Obs.: No geral, instalação de R no windows requer a instalação do Rtools (https://cran.r-project.org/bin/windows/Rtools/)
